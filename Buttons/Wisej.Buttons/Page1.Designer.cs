namespace Wisej.Buttons
{
	partial class Page1
	{
		...
		private void InitializeComponent()
		{
			...
			Wisej.Web.ImageListEntry imageListEntry1 = new Wisej.Web.ImageListEntry("https://icons.iconarchive.com/icons/igh0zt/ios7-style-metro-ui/96/MetroUI-Apps-Ca" +
        "lculator-Alt-icon.png", "MetroUI-Calculator");
			Wisej.Web.ImageListEntry imageListEntry2 = new Wisej.Web.ImageListEntry("https://icons.iconarchive.com/icons/igh0zt/ios7-style-metro-ui/96/MetroUI-Apps-Bl" +
        "uetooth-icon.png", "MetroUI-Apps-Bluetooth-icon");
			...
			// button3
			// 
			this.button3.BackgroundImageSource = "images/test.svg";
			...
			// flowLayoutPanel1
			// 
			this.flowLayoutPanel1.BackgroundImageSource = "images/image.png";
			...
			this.flowLayoutPanel1.Size = new System.Drawing.Size(1216, 423);
			...
			this.Name = "Page1";
			this.Size = new System.Drawing.Size(1216, 423);
